        ...
        <div className="stats-container">
          <div className={`stats-left ${statsVisible ? "fade-in" : ""}`}>
            <div className="stats-header">
              ...
              <p>
                Sacá al máximo las experiencias que podés vivir en Zona Gaming
              </p>
            </div>
            ...
            <div className="feature-box">
              <div className="feature-item">
                ...
                <h3>Batallas Dinámicas</h3>
              </div>

              <div className="feature-item">
                <FaHeart className="feature-icon" />
                <h3>Atmósfera Increíble</h3>
              </div>

              <div className="feature-item">
                <FaUsers className="feature-icon" />
                <h3>Jugá con tus Amigos</h3>
              </div>
            </div>
            ...
            <div className="offer-timer">
              ...
              <h4>Hasta un 10% de Descuento</h4>
              <div className="timer-display">{formatTime(timeLeft)}</div>

              <Link to="/store" className="offer-btn">
                VER MÁS
              </Link>
            </div>
          </div>
